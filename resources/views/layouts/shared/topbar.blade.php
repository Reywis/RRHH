<!-- Topbar Start -->
<header class="app-header top-0 z-50 min-h-topbar flex items-center bg-default-100/5 backdrop-blur-lg">
    <div class="container flex items-center justify-between gap-4">
        <div class="flex items-center gap-5">
            ...
            <!-- Topbar Brand Logo -->
            <a href="{{ route('index')}}" class="md:hidden flex">
                ...
                <div class="hs-dropdown relative inline-flex [--placement:bottom-right]">
                    ...
                    <div
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button type="submit" class="flex items-center py-2 px-3 rounded-md text-sm text-default-800 hover:bg-default-100">
                                Cerrar Sesión
                            </button>
                        </form>
                    </div>
