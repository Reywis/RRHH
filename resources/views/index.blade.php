    ...
    <div class="card">
        <div class="card-body">
            <div class="mb-4">
                ...
                <h5 class="card-title truncate">Empleados Activos</h5>
            </div>

            <div class="flex items-center justify-between mb-4">
                <h2 class="text-3xl font-medium text-default-800">35</h2>
                <span class="flex items-center">
                    <span class="text-default-400 text-sm">90.5%</span>
        ...
        <div class="card-body">
            <div class="mb-4">
                <span class="px-1 py-0.5 text-[10px]/[1.25] font-semibold rounded text-success bg-success/20 float-end">Per
                    MES</span>
                <h5 class="card-title truncate">Contratos Creados</h5>
            </div>

            <div class="flex items-center justify-between mb-4">
                <h2 class="text-3xl font-medium text-default-800">15</h2>
                <span class="flex items-center">
    ...
    <div class="card">
        <div class="card-body">
            <div class="mb-4">
                <span class="px-1 py-0.5 text-[10px]/[1.25] font-semibold rounded text-success bg-success/20 float-end">Per
                    Month</span>
                <h5 class="card-title truncate">Pagos</h5>
            </div>
        ...
        <div class="card-body">
            <div class="mb-4">
                <span class="px-1 py-0.5 text-[10px]/[1.25] font-semibold rounded text-success bg-success/20 float-end">All
                    Time</span>
                <h5 class="card-title truncate">Deducciones</h5>
            </div>
